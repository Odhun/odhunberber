...
export const metadata: Metadata = {
  title: 'Fiyat Listesi',
  description: `${SITE_NAME} hizmet fiyat listesi. Saç kesimi, sakal tıraşı ve daha fazlası için güncel fiyatlar.`,
};
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <div className="mb-12 text-center">
          ...
          <p className="text-dark-400">Tüm hizmetlerimiz için şeffaf ve güncel fiyatlar</p>
        </div>
          ...
          {DEFAULT_SERVICES.map((service, i) => (
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm text-dark-400 mb-2">{service.description}</p>
        ...
        <div className="rounded-xl border border-gold-500/20 bg-gold-500/5 p-4 text-sm text-dark-300 mb-8">
          * Fiyatlar bilgi amaçlıdır. Saç uzunluğuna ve işlem süresine göre değişiklik gösterebilir.
        </div>
